...
function Services() {
 ...
 let ServicesData = [{Img: "url(./public/SaleLogo.png)", Tittle:"Compra y venta en el momento", Description: "Comprá o vendé tu vehículo de manera rápida, segura y al mejor valor del mercado. Te ofrecemos tasaciones justas, opciones de pago flexibles y un acompañamiento profesional en cada paso para que la operación sea simple, ágil y sin complicaciones."}, {Img: "url(./public/finance.png)", Tittle:"Financiacion", Description: "Accedé a planes de financiación flexibles y adaptados a tus necesidades, con cuotas accesibles y distintas opciones de pago. Te asesoramos para que elijas la mejor alternativa y puedas llevarte tu vehículo de forma rápida y sin complicaciones."}, {Img: "url(./public/officialService.png)", Tittle:"Service Oficial", Description: "Realizá el mantenimiento de tu vehículo en nuestro service oficial, con técnicos especializados, repuestos originales y equipamiento de última tecnología. Cuidamos tu auto como corresponde para que mantenga su rendimiento, seguridad y valor a lo largo del tiempo."}]
